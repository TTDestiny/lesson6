...
<![endif]-->
		...
		<script type="text/javascript">
            jQuery(function ($) {
                var demo1 = $('select[name="ids"]').bootstrapDualListbox({infoTextFiltered: '<span class="label label-purple label-lg">Filtered</span>'});
                        ...
                        <div class="col-xs-12">
                            ...
                            <form action="student/student/save_${cmd}.do" method="post" class="form-horizontal"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="on" id="studentName" name="name" readonly
                                               value="${student.name}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select multiple="multiple" size="10" name="ids" id="duallist">
                                            <c:forEach items="${subjects}" var="subject">
                                                <c:if test="${!empty selectedSubjects}">
                                                    <option value="${subject.id}" <c:if test="${lessonTag:contains(selectedSubjects, subject)}"> selected</c:if> >${subject.name}</option>
                                                </c:if>
                                                <c:if test="${empty selectedSubjects}">

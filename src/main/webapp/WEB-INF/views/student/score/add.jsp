...
<lesson:page title="user.title.${cmd}">
    <jsp:attribute name="script">
        ...
        <script src="../../../../static-resource/common/js/jquery.serializejson.js"></script>
        <script type="application/javascript">
            ...
            jQuery(document).ready(function () {
                ...
                $("#submitForm").click(function () {
                 ...
                 var formData = $("#scoreForm").serializeJSON();
                    $.ajax(
                        {
                            async:false,
                            type:'POST',
                            contentType: 'application/json',
                            url:"/student/score/save_add.do",
                            data:JSON.stringify(formData),
                            success:function (data) {
                                if (data){
                                    alert("分数录入成功！")
                                    window.location.href="/student/student/list.do"
                                }else {
                                    alert("请重新录入！");
                                    location.reload();
                                }
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="student/score/save_${cmd}.do" id="scoreForm" method="post"
                                ...
                                <c:forEach items="${studentSubjects}" var="studentSubject">
                                    <input type="hidden" value="${student_id}" id="student_id" name="studentSubject[][student_id]"/>
                                    <div class="form-group">
                                        <div class="col-xs-1  col-lg-offset-3">
                                            <input type="text"  value=" ${studentSubject.subject.name}" readonly class=" form-control"/>
                                            <input type="hidden" name="studentSubject[][subject_id]" value="${studentSubject.subject.id}">
                                        </div>
                                        <div class="col-xs-3">
                                            <input type="text" autocomplete="off" name="studentSubject[][score]"
